...
export default function Navbar() {
  ...
  return (
    <motion.header
      ...
      className="fixed left-1/2 top-4 z-[120] w-[min(1180px,94vw)] -translate-x-1/2"
    >
      <nav
      ...
      >
        ...
        <ul className="hidden items-center gap-1 md:flex">
          {LINKS.map((l) => (
            <li key={l.href}>
              ...
              >
                <span className="absolute inset-0 scale-90 rounded-full bg-white/[0.06] opacity-0 transition-all duration-500 ease-luxe group-hover:scale-100 group-hover:opacity-100" />
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="grid h-9 w-9 place-items-center rounded-full border border-white/10 text-silver transition hover:border-electric/40 hover:text-frost"
          >
          ...
          {LINKS.map((l) => (
            <li key={l.href}>
              <a
                ...
                className="block rounded-2xl px-4 py-3 text-sm text-silver transition hover:bg-white/5 hover:text-frost"
              >
                {l.label}
              </a>
            </li>
